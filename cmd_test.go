...
func TestCalculate(t *testing.T) {
	...
	t.Run("Single item", func(t *testing.T){
		...
		got := calculate(strs, prices, false)

		want := float32(3.11)
		
		if math.Abs(float64(got - want)) > Threshhold {
	...
	t.Run("APOM policy with two items", func(t *testing.T) {
